...
class App {
  ...
  private registerModules() {
    ...
    this.app.use(RouteVersion.v1, routes.familyManagement);
    this.app.use(RouteVersion.v1, routes.leaveManagement);
    this.app.use(RouteVersion.v1, routes.staffManagement);
    this.app.use(RouteVersion.v1, routes.volunteerManagement);
    this.app.use(RouteVersion.v1, routes.eventManagement);
    this.app.use(RouteVersion.v1, routes.prayerManagement);
    this.app.use(RouteVersion.v1, routes.groupManagement);
    this.app.use(RouteVersion.v1, routes.sacramentManagement);
    this.app.use(RouteVersion.v1, routes.courseManagement);
    this.app.use(RouteVersion.v1, routes.campusManagement);
    this.app.use(RouteVersion.v1, routes.facilityManagement);
    this.app.use(RouteVersion.v1, routes.documentManagement);
    this.app.use(RouteVersion.v1, routes.communicationManagement);
    this.app.use(RouteVersion.v1, routes.assetManagement);
